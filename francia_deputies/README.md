...
| **zeeschuimer/**     | Capturo tweets de las cuentas de los diputados con Zeeschuimer (cuenta por cuenta, ~15 min de scroll por cuenta, ~400 tweets). Los scripts generan la lista de URLs y luego unifican los ndjson con el CSV de diputados; me quedo con el texto para el análisis. Ver **zeeschuimer/README_ZEESCHUIMER.md**. |
